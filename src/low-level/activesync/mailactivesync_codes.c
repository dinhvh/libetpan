...
static const struct mailactivesync_wbxml_token_info wbxml_tokens[] = {
  ...
  { MAILACTIVESYNC_CP_EMAIL, 0x0C, "Email:Body" },
  { MAILACTIVESYNC_CP_EMAIL, 0x0D, "Email:BodySize" },
  { MAILACTIVESYNC_CP_EMAIL, 0x0E, "Email:BodyTruncated" },
  ...
  { MAILACTIVESYNC_CP_EMAIL, 0x1A, "Email:TimeZone" },
  { MAILACTIVESYNC_CP_EMAIL, 0x1B, "Email:Categories" },
  { MAILACTIVESYNC_CP_EMAIL, 0x1C, "Email:Category" },
  { MAILACTIVESYNC_CP_EMAIL, 0x35, "Email:ThreadTopic" },
  { MAILACTIVESYNC_CP_EMAIL, 0x36, "Email:MIMEData" },
  { MAILACTIVESYNC_CP_EMAIL, 0x37, "Email:MIMETruncated" },
  { MAILACTIVESYNC_CP_EMAIL, 0x38, "Email:MIMESize" },
  { MAILACTIVESYNC_CP_EMAIL, 0x39, "Email:InternetCPID" },
  { MAILACTIVESYNC_CP_EMAIL, 0x3A, "Email:Flag" },
  { MAILACTIVESYNC_CP_EMAIL, 0x3B, "Email:Status" },
  { MAILACTIVESYNC_CP_EMAIL, 0x3C, "Email:ContentClass" },
  { MAILACTIVESYNC_CP_EMAIL, 0x3D, "Email:FlagType" },
  { MAILACTIVESYNC_CP_EMAIL, 0x3E, "Email:CompleteTime" },

  { MAILACTIVESYNC_CP_MOVE, 0x05, "Move:MoveItems" },
  ...
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x05, "ResolveRecipients:ResolveRecipients" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x06, "ResolveRecipients:Response" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x07, "ResolveRecipients:Status" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x08, "ResolveRecipients:Type" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x09, "ResolveRecipients:Recipient" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x0A, "ResolveRecipients:DisplayName" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x0B, "ResolveRecipients:EmailAddress" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x0C, "ResolveRecipients:Certificates" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x0D, "ResolveRecipients:Certificate" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x0E, "ResolveRecipients:MiniCertificate" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x0F, "ResolveRecipients:Options" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x10, "ResolveRecipients:To" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x11, "ResolveRecipients:CertificateRetrieval" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x12, "ResolveRecipients:RecipientCount" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x13, "ResolveRecipients:MaxCertificates" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x14, "ResolveRecipients:MaxAmbiguousRecipients" },
  { MAILACTIVESYNC_CP_RESOLVERECIPIENTS, 0x15, "ResolveRecipients:CertificateCount" },
  { MAILACTIVESYNC_CP_VALIDATECERT, 0x05, "ValidateCert:ValidateCert" },
  { MAILACTIVESYNC_CP_VALIDATECERT, 0x06, "ValidateCert:Certificates" },
  { MAILACTIVESYNC_CP_VALIDATECERT, 0x07, "ValidateCert:Certificate" },
  { MAILACTIVESYNC_CP_VALIDATECERT, 0x08, "ValidateCert:CertificateChain" },
  { MAILACTIVESYNC_CP_VALIDATECERT, 0x09, "ValidateCert:CheckCRL" },
  { MAILACTIVESYNC_CP_VALIDATECERT, 0x0A, "ValidateCert:Status" },
  ...
  { MAILACTIVESYNC_CP_SEARCH, 0x05, "Search:Search" },
  { MAILACTIVESYNC_CP_SEARCH, 0x07, "Search:Store" },
  { MAILACTIVESYNC_CP_SEARCH, 0x08, "Search:Name" },
  { MAILACTIVESYNC_CP_SEARCH, 0x09, "Search:Query" },
  { MAILACTIVESYNC_CP_SEARCH, 0x0A, "Search:Options" },
  { MAILACTIVESYNC_CP_SEARCH, 0x0B, "Search:Range" },
  { MAILACTIVESYNC_CP_SEARCH, 0x0C, "Search:Status" },
  { MAILACTIVESYNC_CP_SEARCH, 0x0D, "Search:Response" },
  { MAILACTIVESYNC_CP_SEARCH, 0x0E, "Search:Result" },
  { MAILACTIVESYNC_CP_SEARCH, 0x0F, "Search:Properties" },
  { MAILACTIVESYNC_CP_SEARCH, 0x10, "Search:Total" },
  { MAILACTIVESYNC_CP_SEARCH, 0x11, "Search:EqualTo" },
  { MAILACTIVESYNC_CP_SEARCH, 0x12, "Search:Value" },
  { MAILACTIVESYNC_CP_SEARCH, 0x13, "Search:And" },
  { MAILACTIVESYNC_CP_SEARCH, 0x14, "Search:Or" },
  { MAILACTIVESYNC_CP_SEARCH, 0x15, "Search:FreeText" },
  { MAILACTIVESYNC_CP_SEARCH, 0x17, "Search:DeepTraversal" },
  { MAILACTIVESYNC_CP_SEARCH, 0x18, "Search:LongId" },
  { MAILACTIVESYNC_CP_SEARCH, 0x19, "Search:RebuildResults" },
  { MAILACTIVESYNC_CP_SEARCH, 0x1A, "Search:LessThan" },
  { MAILACTIVESYNC_CP_SEARCH, 0x1B, "Search:GreaterThan" },
  { MAILACTIVESYNC_CP_SEARCH, 0x1E, "Search:UserName" },
  { MAILACTIVESYNC_CP_SEARCH, 0x1F, "Search:Password" },
  { MAILACTIVESYNC_CP_SEARCH, 0x20, "Search:ConversationId" },

  { MAILACTIVESYNC_CP_FIND, 0x05, "Find:Find" },
  { MAILACTIVESYNC_CP_FIND, 0x06, "Find:SearchId" },
  { MAILACTIVESYNC_CP_FIND, 0x07, "Find:ExecuteSearch" },
  { MAILACTIVESYNC_CP_FIND, 0x08, "Find:MailBoxSearchCriterion" },
  { MAILACTIVESYNC_CP_FIND, 0x09, "Find:Query" },
  { MAILACTIVESYNC_CP_FIND, 0x0A, "Find:Status" },
  { MAILACTIVESYNC_CP_FIND, 0x0B, "Find:FreeText" },
  { MAILACTIVESYNC_CP_FIND, 0x0C, "Find:Options" },
  { MAILACTIVESYNC_CP_FIND, 0x0D, "Find:Range" },
  { MAILACTIVESYNC_CP_FIND, 0x0E, "Find:DeepTraversal" },
  { MAILACTIVESYNC_CP_FIND, 0x11, "Find:Response" },
  { MAILACTIVESYNC_CP_FIND, 0x12, "Find:Result" },
  { MAILACTIVESYNC_CP_FIND, 0x13, "Find:Properties" },
  { MAILACTIVESYNC_CP_FIND, 0x14, "Find:Preview" },
  { MAILACTIVESYNC_CP_FIND, 0x15, "Find:HasAttachments" },
  { MAILACTIVESYNC_CP_FIND, 0x16, "Find:Total" },
  { MAILACTIVESYNC_CP_FIND, 0x17, "Find:DisplayCc" },
  { MAILACTIVESYNC_CP_FIND, 0x18, "Find:DisplayBcc" },
  ...
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x19, "AirSyncBase:BodyPartPreference" },
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x1A, "AirSyncBase:BodyPart" },
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x1B, "AirSyncBase:Status" },
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x1C, "AirSyncBase:Add" },
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x1D, "AirSyncBase:Delete" },
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x1E, "AirSyncBase:ClientId" },
  { MAILACTIVESYNC_CP_AIRSYNCBASE, 0x1F, "AirSyncBase:Content" },

  { MAILACTIVESYNC_CP_RIGHTSMANAGEMENT, 0x05,
  ...
  { MAILACTIVESYNC_CP_EMAIL2, 0x09, "Email2:ConversationId" },
  { MAILACTIVESYNC_CP_EMAIL2, 0x0A, "Email2:ConversationIndex" },
  { MAILACTIVESYNC_CP_EMAIL2, 0x14, "Email2:IsDraft" },
  { MAILACTIVESYNC_CP_EMAIL2, 0x15, "Email2:Bcc" },
  { MAILACTIVESYNC_CP_EMAIL2, 0x16, "Email2:Send" }
};
